...
![1629877485595](../../images/img/1629877485595.png)
...
![1629968793799](../../images/img//1629968793799.png)
...
![1630032137816](../../images/img//1630032137816.png)
...
![1629877968367](../../images/img//1629877968367.png)
...
![1629878047871](../../images/img//1629878047871.png)

![1629878065195](../../images/img//1629878065195.png)

> 可以将某些常用命令持久化在硬盘上：

![1629878182887](../../images/img//1629878182887.png)
...
![1630745315617](../../images/img//1630745315617.png)
...
![1630743436323](../../images/img//1630743436323.png)
...
![1630744256988](../../images/img//1630744256988.png)
...
![1630987332315](../../images/img//1630987332315.png)
...
![1630741892162](../../images/img//1630741892162.png)
...
![1631003992014](../../images/img//1631003992014.png)
...
![1631073757234](../../images/img//1631073757234.png)

![1631073770033](../../images/img//1631073770033.png)

![1631074436015](../../images/img//1631074436015.png)
...
![1631094038083](../../images/img//1631094038083.png)
...
![1631589225439](../../images/img//1631589225439.png)
...
当CMS停止工作时,会把 Serial Old GC作为备选方案,而它是JVM中性能最差的垃圾收集方式,停顿几秒甚至十秒都有可能移除了CMS垃圾收集器,如果继续在JDK14中使用-XX:+UseConcMarkSweepGC 不会报错,仅仅给出一个warning警告
...
### 6.4.4、ZGC on macOS and Windows
...
![1631591809475](../../images/img//1631591809475.png)

![1631592040352](../../images/img//1631592040352.png)
...
![1631086461797](../../images/img//1631086461797.png)
...
![1631087081162](../../images/img//1631087081162.png)
...
![1631087823799](../../images/img//1631087823799.png)

如果有友好提示

![1631087848805](../../images/img//1631087848805.png)

这时就可以发现,是j的问题,那么其实就是b对象的问题

### 6.5.2、JAVA打包工具  JEP343(孵化阶段)
...
![1631670467582](../../images/img//1631670467582.png)

![1631670520496](../../images/img//1631670520496.png)

一个孵化器阶段,三个预览,两个废弃和两个移除

JAVA15参与企业

![1631676405146](../../images/img//1631676405146.png)
...
![1631675941015](../../images/img//1631675941015.png)
...
![1631797518607](../../images/img//1631797518607.png)
...
![1631799306032](../../images/img//1631799306032.png)

![1631801073728](../../images/img//1631801073728.png)

## 8.2、语法层面

### 8.2.1、JEP 397：密封类（第二次预览）
...
### 8.2.2、JEP 394：instanceof 的模式匹配
...
### 8.4.2、JEP 357：从 Mercurial 迁移到 Git
...
### 8.4.7、JEP 388：Windows/AArch64 端口
...
### 8.4.10、JEP 393：外部内存访问 API（第三个孵化器）
...
- `MemoryAddress`对一个地址建模，该地址可以驻留在堆上或堆外，并且
...
### 8.4.11、JEP 396：默认情况下强封装 JDK 内部
...
![1631802196015](../../images/img//1631802196015.png)

Java 17+ 可以免费使用了，包括商用，更详细的条款可以阅读：

> https://www.oracle.com/downloads/licenses/no-fee-license.html

![1631802323345](../../images/img//1631802323345.png)
...
![1631802422250](../../images/img//1631802422250.png)

OpenJDK文档

> https://openjdk.java.net/projects/jdk/17/

![1631802460848](../../images/img//1631802460848.png)
...
### 9.3.1、JEP 414：Vector API（第二个孵化器）
...
### 9.4.4、JEP 391：macOS/AArch64 端口
...
### 9.4.5、JEP 398：弃用 Applet API 以进行删除
...
### 9.4.8、JEP 410：删除实验性 AOT 和 JIT 编译器
...
### 9.4.10、JEP 412：外部函数和内存 API（孵化器）
